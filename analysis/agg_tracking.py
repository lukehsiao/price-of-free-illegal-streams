...
if __name__=='__main__':
    ...
    third_parties = {}
    cookies = {}
    with open('third_party_json.txt', 'r') as f:
        third_parties = json.load(f)

    with open('cookies_json.txt', 'r') as f:
        cookies = json.load(f)
    ...
    for key, value in third_parties.items():
        ...
        if aggregator not in all_aggs:
            ...
            all_aggs[aggregator] = (all_aggs[aggregator][0] + requests, all_aggs[aggregator][1] + trackers)
